...
public class DefaultParserTest {
    ...
    @Test
    public void testBackslashPreservedInSingleQuotes() {
        DefaultParser parser = new DefaultParser();
    ...
    @Test
    public void testBackslashPreservedInDoubleQuotes() {
        DefaultParser parser = new DefaultParser();
        CompletingParsedLine line = (CompletingParsedLine) parser.parse("source \"C:\\windows\\path\"", 0);
        assertNotNull(line);
        assertEquals(2, line.words().size());
    ...
    @Test
    public void testBackslashBeforeQuoteInDoubleQuotes() {
        DefaultParser parser = new DefaultParser();
    ...
    @Test
    public void testBackslashStrippedOutsideQuotes() {
        DefaultParser parser = new DefaultParser();
