...
public class ConfigurationTest {
    ...
    public void testInput() throws Exception {
        Configuration config = new Configuration("JLine", getClass().getResourceAsStream("config1"));
        ...
        config = new Configuration("bash", getClass().getResourceAsStream("config1"));
        assertEquals("\u001bb\"\u001bf\"", config.getKeys().getBound(((char)('X' - 'A' + 1)) + "q"));
    }

    @Test
    public void testInput2() throws Exception {
        Configuration config = new Configuration("JLine", getClass().getResourceAsStream("config2"));
    }
