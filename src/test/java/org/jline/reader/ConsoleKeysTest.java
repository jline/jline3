...
public class ConsoleKeysTest extends ReaderTestSupport {
    ...
    public void testInputBadConfig() throws Exception {
        ConsoleKeys keys = new ConsoleKeys("Bash", getClass().getResource("/jline/internal/config-bad"));
    ...
    public void testInput() throws Exception {
        ConsoleKeys keys = new ConsoleKeys("JLine", getClass().getResource("/jline/internal/config1"));
        ...
        keys = new ConsoleKeys("bash", getClass().getResource("/jline/internal/config1"));
        assertEquals(new Macro("\u001bb\"\u001bf\""),
                keys.getKeys().getBound(ctrl('X') + "q"));
    }
    ...
    public void testInput2() throws Exception {
        ConsoleKeys keys = new ConsoleKeys("Bash", getClass().getResource("/jline/internal/config2"));
