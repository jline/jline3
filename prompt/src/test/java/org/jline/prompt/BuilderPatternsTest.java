...
public class BuilderPatternsTest {
    ...
    void testListBuilderChaining() {
        ...
        PromptBuilder result = builder.createListPrompt()
                ...
                .newItem("item1").text("Option 1").add()
                .newItem("item2").text("Option 2").add()
                .addPrompt();
    ...
    void testCheckboxBuilderChaining() {
        ...
        PromptBuilder result = builder.createCheckboxPrompt()
                ...
                .newItem("cb1").text("Checkbox 1").checked(true).add()
                .newItem("cb2").text("Checkbox 2").add()
                .newItem("cb3").text("Checkbox 3").checked(false).add()
                .addPrompt();
