...
class DefaultPrompterTest {
    ...
    void testListPromptCreation() {
        ...
        assertInstanceOf(ListPrompt.class, prompt);
    ...
    @Test
    void testCheckboxPromptCreation() {
        ...
        Prompt prompt = prompts.get(0);
        assertInstanceOf(CheckboxPrompt.class, prompt);
    ...
    void testChoicePromptCreation() {
        ...
        Prompt prompt = prompts.get(0);
        assertInstanceOf(ChoicePrompt.class, prompt);
    ...
    void testMultiplePromptsInBuilder() {
        ...
        assertInstanceOf(ConfirmPrompt.class, prompts.get(1));
        assertInstanceOf(InputPrompt.class, prompts.get(2));
    }

    // TODO: What does this test, the functionality of lists?
    @Test
    void testEmptyPromptList() {
        // Test behavior with empty prompt list
        List<AttributedString> header = List.of(new AttributedString("Test Header"));
