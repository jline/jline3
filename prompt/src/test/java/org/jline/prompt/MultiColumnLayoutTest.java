...
public class MultiColumnLayoutTest {
    ...
    void testSingleColumnLayout() throws IOException {
        ...
        builder.createListPrompt()
                .name("single-column")
                .message("Choose:")
                .newItem("item1").text("Short").add()
                .newItem("item2").text("Also short").add()
                .addPrompt();
    ...
    void testMultipleItemsForColumnLayout() throws IOException {
        ...
        builder.createListPrompt()
                ...
                .newItem("opt2").text("Option 2").add()
                .newItem("opt3").text("Option 3").add()
                .newItem("opt4").text("Option 4").add()
                .newItem("opt5").text("Option 5").add()
                .newItem("opt6").text("Option 6").add()
                .newItem("opt7").text("Option 7").add()
                .newItem("opt8").text("Option 8").add()
                .addPrompt();
    ...
    void testCheckboxMultiColumnLayout() throws IOException {
        ...
        builder.createCheckboxPrompt()
                ...
                .newItem("cb1").text("Checkbox 1").add()
                .newItem("cb2").text("Checkbox 2").checked(true).add()
                .newItem("cb3").text("Checkbox 3").add()
                .newItem("cb4").text("Checkbox 4").checked(true).add()
                .newItem("cb5").text("Checkbox 5").add()
                .newItem("cb6").text("Checkbox 6").add()
                .addPrompt();
    ...
    void testChoicePromptWithMultipleOptions() throws IOException {
        ...
        builder.createChoicePrompt()
                ...
                .newChoice("rename").text("Rename file").key('r').add()
                .addPrompt();
    ...
    void testMixedItemLengths() throws IOException {
        ...
        builder.createListPrompt()
                .name("mixed-lengths")
                .message("Choose:")
                .newItem("short").text("A").add()
                .newItem("medium").text("Medium length option").add()
                .newItem("long").text("This is a very long option that might affect column layout").add()
                .newItem("short2").text("B").add()
                .newItem("medium2").text("Another medium option").add()
                .addPrompt();
    ...
    void testSingleItemPrompt() throws IOException {
        ...
        builder.createListPrompt()
                ...
                .newItem("only").text("Only Option").add()
                .addPrompt();
