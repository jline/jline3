                ...
                try {
                    while (true) {
                        ...
                        if (input != null) {
                            ...
                            // Update status bar
                            SwingUtilities.invokeLater(() -> 
                                statusBar.setText("Last input: " + input.replace("\r", "\\r").replace("\n", "\\n")));
                        }
                    }
                } catch (InterruptedException e) {
                    Thread.currentThread().interrupt();
    ...
    private static class JFontChooser {
        public static Font showDialog(Component parent, String title, Font initialFont) {
            ...
            String selectedFont = (String) JOptionPane.showInputDialog(
                parent, "Choose a font:", title,
                JOptionPane.PLAIN_MESSAGE, null, fontNames, initialFont.getName());
            
            if (selectedFont != null) {
                String[] sizes = {"8", "9", "10", "11", "12", "14", "16", "18", "20", "24", "28", "32"};
                String selectedSize = (String) JOptionPane.showInputDialog(
                    parent, "Choose font size:", title,
                    JOptionPane.PLAIN_MESSAGE, null, sizes, String.valueOf(initialFont.getSize()));
