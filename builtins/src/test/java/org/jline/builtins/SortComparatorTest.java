...
class SortComparatorTest {
    ...
    void testBasicSorting() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, '\0', List.of("1"));
    ...
    void testCaseInsensitiveSorting() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(true, false, false, false, '\0', List.of("1"));
    ...
    void testReverseSorting() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, true, false, false, '\0', List.of("1"));
    ...
    void testNumericSorting() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, true, '\0', List.of("1"));
    ...
    void testIgnoreLeadingBlanks() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, true, false, '\0', List.of("1"));
    ...
    void testFieldSeparator() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, ':', List.of("2"));
    ...
    void testMultipleKeys() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, ':', List.of("1", "2"));
    ...
    void testKeyWithModifiers() {
        ...
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, ':', List.of("2n"));
    ...
    void testKeyWithReverseModifier() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, ':', List.of("2r"));
    ...
    void testKeyWithCaseInsensitiveModifier() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, ':', List.of("2f"));
    ...
    void testKeyWithIgnoreBlanksModifier() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, ':', List.of("2b"));
    ...
    void testComplexKey() {
        ...
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, ':', List.of("2,3nr"));
    ...
    void testWhitespaceHandling() {
        PosixCommands.SortComparator comparator =
                new PosixCommands.SortComparator(false, false, false, false, '\0', List.of("2"));
