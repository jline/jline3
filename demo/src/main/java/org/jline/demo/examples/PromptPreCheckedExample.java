...
public class PromptPreCheckedExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        builder.createCheckboxPrompt()
                ...
                .newItem("logging").text("Enable Logging").checked(true).add()  // Recommended
                .newItem("metrics").text("Enable Metrics").checked(true).add()  // Recommended
                .newItem("debug").text("Debug Mode").checked(false).add()       // Not recommended for production
                .newItem("cache").text("Enable Caching").checked(true).add()    // Recommended
                .newItem("compression").text("Enable Compression").checked(false).add()
                .newItem("ssl").text("Force SSL").checked(true).add()           // Recommended for security
                .newItem("cors").text("Enable CORS").checked(false).add()
                .addPrompt();
