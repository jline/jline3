...
public class PromptDisabledItemsExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        builder.createListPrompt()
                ...
                .newItem("free").text("Free Plan").add()
                .newItem("basic").text("Basic Plan - $9.99/month").add()
                .newItem("premium").text("Premium Plan - $19.99/month").add()
        ...
        builder.createCheckboxPrompt()
                ...
                .newItem("backup").text("Daily Backup").add()
                .newItem("ssl").text("SSL Certificate").add()
