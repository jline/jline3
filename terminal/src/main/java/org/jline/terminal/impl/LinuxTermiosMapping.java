...
public class LinuxTermiosMapping extends TermiosMapping {

    /** Singleton instance. */
    public static final LinuxTermiosMapping INSTANCE = new LinuxTermiosMapping();

    private LinuxTermiosMapping() {
    ...
    private static EnumMap<LocalFlag, Long> localFlags() {
        ...
        map.put(LocalFlag.FLUSHO, 0x0001000L);
