...
public final class KittyKeyboardSupport {
    ...
    // ---- Special Key Codes ----
    // Keys with standard Unicode/ASCII codepoints (used in CSI u sequences):
    ...
    // Navigation keys — PUA codepoints defined by the kitty protocol.
    // These keys normally use legacy CSI number ~ encoding, but we define the
     ...
     */
    @SuppressWarnings("java:S1319") // EnumSet matches JLine API convention (see Attributes)
